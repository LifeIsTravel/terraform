...
sed -i "s|^dags_folder = .*|dags_folder = s3://lifeistravel-airflow-dags/dags/|" /home/ubuntu/airflow/airflow.cfg
...
sed -i "s|^sql_alchemy_conn = .*|sql_alchemy_conn = postgresql+psycopg2://username:passowrd@"${meta_db_url}"/airflow|" /home/ubuntu/airflow/airflow.cfg
...
[Unit]
Description=Webserver Startup Script
